  ...
  return [
    ...
    },
    {
      ...
      dag: {
        ...
        taskRunId,
        ts: 3.25,
        summary: 'public acceptance DAG for export fixture',
        publicReason: 'derived from visible task contract',
        nodes: [
          {
            id: 'requirements',
            kind: 'requirement',
            title: 'Extract visible requirements',
            description: 'Use public task text only',
            status: 'completed',
            dependsOn: [],
            acceptanceCriteria: ['requirements are listed'],
            required: true,
            selfCheck: {
              status: 'pass',
              publicReason: 'public node check passed',
          ...
          },
          {
            id: 'deliverable',
            kind: 'deliverable',
            title: 'Produce final artifact',
            description: 'Create visible deliverable',
            status: 'completed',
          ...
          },
          {
            ...
            description: 'Apply public implementation work',
            status: 'completed',
            dependsOn: ['deliverable'],
            acceptanceCriteria: ['implementation is present'],
            required: true,
            selfCheck: {
              status: 'pass',
              publicReason: 'public node check passed',
          ...
          },
          {
            id: 'final-audit',
            kind: 'final_audit',
            title: 'Audit final state',
            description: 'Review public evidence',
            status: 'completed',
            dependsOn: ['public-check'],
            acceptanceCriteria: ['all required evidence is present'],
            required: true,
            selfCheck: {
              status: 'pass',
              publicReason: 'public node check passed',
